...
const STORAGE_KEY = 'step7-checklist'
...
export default function Step7Checklist() {
  ...
  return (
    <div className="rounded-2xl bg-[#e0e5ec] p-6 shadow-[5px_5px_10px_#bebebe,-5px_-5px_10px_#ffffff]">
      <h2 className="mb-4 flex items-center gap-2 text-xl font-bold">
        <span className="text-2xl">✅</span> Checklist Akhir Tahap 7
      </h2>
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Zustand Setup</td>
              ...
              <td className="py-2">
                Store <code>ui-store.ts</code> sudah dibuat.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Global UI State</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[1]}
              ...
              <td className="py-2">
                Klik tombol di Navbar → Sidebar terbuka/tertutup.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              ...
              <td className="py-2">
                Buka Sidebar → Refresh Halaman → Sidebar tetap terbuka.
              </td>
            </tr>
            <tr>
              <td className="py-2 pr-4">State Separation</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[3]}
              ...
              <td className="py-2">
                Pastikan tidak ada data User/DB di dalam Zustand store.
              </td>
            </tr>
          </tbody>
        </table>
