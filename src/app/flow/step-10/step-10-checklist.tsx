...
const STORAGE_KEY = 'step10-checklist'
...
export default function Step10Checklist() {
  ...
  return (
    <div className="rounded-2xl bg-[#e0e5ec] p-6 shadow-[5px_5px_10px_#bebebe,-5px_-5px_10px_#ffffff]">
      <h2 className="mb-4 flex items-center gap-2 text-xl font-bold">
        <span className="text-2xl">✅</span> Checklist Akhir Tahap 10
      </h2>
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Dockerfile</td>
              ...
              <td className="py-2">
                <code>docker build .</code> selesai tanpa error.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              ...
              <td className="py-2">
                <code>docker-compose up</code> menjalankan app + PostgreSQL.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">CI Pipeline</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[2]}
              ...
              <td className="py-2">
                Push ke GitHub → Actions menjalankan lint, test, build.
              </td>
            </tr>
            <tr>
              <td className="py-2 pr-4">Deployment Plan</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[3]}
              ...
              <td className="py-2">
                Tentukan antara Vercel (serverless) atau VPS Docker.
              </td>
            </tr>
          </tbody>
        </table>
