...
const STORAGE_KEY = 'step6-checklist'
  ...
  return (
    <div className="rounded-2xl bg-[#e0e5ec] p-6 shadow-[5px_5px_10px_#bebebe,-5px_-5px_10px_#ffffff]">
      <h2 className="mb-4 flex items-center gap-2 text-xl font-bold">
        <span className="text-2xl">✅</span> Checklist Akhir Tahap 6
      </h2>
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Zod Schemas</td>
              ...
              <td className="py-2">
                File di <code>src/validations/</code> sudah terdefinisi.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Client Validation</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[1]}
              ...
              <td className="py-2">
                Kosongkan input → Muncul pesan error merah di bawah field.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Server Validation</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[2]}
              ...
              <td className="py-2">
                Data tidak valid dikirim ke server → Server menolak request.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Loading State</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[3]}
              ...
              <td className="py-2">
                Klik submit → Tombol berubah jadi &quot;Memproses...&quot; dan
                disabled.
              </td>
            </tr>
            <tr>
              <td className="py-2 pr-4">UX Feedback</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[4]}
              ...
              <td className="py-2">
                Berhasil daftar → Muncul toast sukses dari Sonner.
              </td>
            </tr>
          </tbody>
        </table>
