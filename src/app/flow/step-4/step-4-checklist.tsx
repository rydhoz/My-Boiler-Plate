...
const STORAGE_KEY = 'step4-checklist'
  ...
  return (
    <div className="rounded-2xl bg-[#e0e5ec] p-6 shadow-[5px_5px_10px_#bebebe,-5px_-5px_10px_#ffffff]">
      <h2 className="mb-4 flex items-center gap-2 text-xl font-bold">
        <span className="text-2xl">✅</span> Checklist Akhir Tahap 4
      </h2>
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">NextAuth Setup</td>
              ...
              <td className="py-2">
                File <code>src/server/auth.ts</code> dan API route sudah ada.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Register Flow</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[1]}
              ...
              <td className="py-2">
                Isi form register → User muncul di Prisma Studio.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Login Flow</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[2]}
              ...
              <td className="py-2">
                Login dengan email/pass → Masuk ke Dashboard.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              ...
              <td className="py-2">
                Coba buka /dashboard tanpa login → Terlempar ke /login.
              </td>
            </tr>
            <tr>
              <td className="py-2 pr-4">Logout</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[4]}
              ...
              <td className="py-2">
                Klik logout → Tidak bisa akses /dashboard lagi.
              </td>
            </tr>
          </tbody>
        </table>
