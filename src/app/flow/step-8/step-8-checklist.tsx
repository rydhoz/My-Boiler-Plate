...
const STORAGE_KEY = 'step8-checklist'
...
export default function Step8Checklist() {
  ...
  return (
    <div className="rounded-2xl bg-[#e0e5ec] p-6 shadow-[5px_5px_10px_#bebebe,-5px_-5px_10px_#ffffff]">
      <h2 className="mb-4 flex items-center gap-2 text-xl font-bold">
        <span className="text-2xl">✅</span> Checklist Akhir Tahap 8
      </h2>
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Testing Environment</td>
              ...
              <td className="py-2">
                Vitest dan Playwright terinstall, konfigurasi ada.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Unit Test</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[1]}
              ...
              <td className="py-2">
                <code>npx vitest run</code> lulus tanpa error.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">Integration Test</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[2]}
              ...
              <td className="py-2">
                Form validasi dan submit berhasil diuji.
              </td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="py-2 pr-4">E2E Test</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[3]}
              ...
              <td className="py-2">
                <code>npx playwright test</code> lulus.
              </td>
            </tr>
            <tr>
              <td className="py-2 pr-4">CI Ready</td>
              <td className="py-2 pr-4">
                <input
                  type="checkbox"
                  checked={checklist[4]}
              ...
              <td className="py-2">
                Script <code>test</code> dan <code>test:e2e</code> ada di{' '}
